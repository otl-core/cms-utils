...
/**
 * Resolve multivariate collection entry content to a single variant's blocks.
 * Collection entry layouts are collection-level (no variants). The entry's content blocks
 ...
 */
export function resolveEntryVariant(content, bucket) {
